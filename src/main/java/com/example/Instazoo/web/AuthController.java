...
import com.example.Instazoo.validators.ResponseErrorValidation;
...
public class AuthController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<Object> authentication(@Valid @RequestBody LoginRequest loginRequest, BindingResult bindingResult){
